    ...
    <div class="row">
        <div class="col-md-6">
            <form method="post" action="postAction.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Title:</label>
                    <input type="text" name="title" class="form-control" placeholder="eg.wallet,key" value="<?php echo !empty($galData['title'])?$galData['title']:''; ?>" >
                </div>
                <div>
                    <label>Found Location:</label>
                    <input type="text" name='found_location' class="form-control" placeholder="Location" value="<?php echo !empty($galData['title'])?$galData['title']:''; ?>" >
                </div><br>
                <div>
                    <label>Drop box:</label>
                    <input type="text" name='drop_box' class="form-control" placeholder="Drop box" value="<?php echo !empty($galData['title'])?$galData['title']:''; ?>" >
                </div><br>
